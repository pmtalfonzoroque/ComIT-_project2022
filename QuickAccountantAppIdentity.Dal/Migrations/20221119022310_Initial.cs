        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncomeGroup = table.Column<byte>(type: "tinyint", nullable: false),
                    PayMethod = table.Column<byte>(type: "tinyint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExpenseGroup = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncomeRecordType", x => new { x.IncomeRecordId, x.IncomeTypeId });
                    table.ForeignKey(
                        name: "FK_IncomeRecordType_IncomeRecord_IncomeRecordId",
                        column: x => x.IncomeRecordId,
                        principalTable: "IncomeRecord",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IncomeRecordType_IncomeType_IncomeTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseRecordType", x => new { x.ExpenseRecordId, x.ExpenseTypeId });
                    table.ForeignKey(
                        name: "FK_ExpenseRecordType_ExpenseRecord_ExpenseRecordId",
                        column: x => x.ExpenseRecordId,
                        principalTable: "ExpenseRecord",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpenseRecordType_ExpenseType_ExpenseTypeId",
                        column: x => x.ExpenseTypeId,
                        principalTable: "ExpenseType",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseRecordType_ExpenseTypeId",
                table: "ExpenseRecordType",
                column: "ExpenseTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_IncomeRecordType_IncomeTypeId",
